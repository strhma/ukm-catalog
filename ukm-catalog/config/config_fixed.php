...
ndefine('REMEMBER_ME_LIFETIME', 2592000); // 30 days
...
ndefine('CACHE_ENABLED', APP_ENV === 'production');
...
try {
    ...
    if (file_exists(INCLUDES_PATH . 'auth_fixed.php')) {
        require_once INCLUDES_PATH . 'auth_fixed.php';
    } else {
